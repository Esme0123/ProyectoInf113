...
CREATE TABLE `pedidos` (
  ...
  KEY `pedidos_facturas_FK` (`id_factura`),
  CONSTRAINT `pedidos_clientes_FK` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`),
  CONSTRAINT `pedidos_facturas_FK` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id_factura`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-10-17 21:58:35
